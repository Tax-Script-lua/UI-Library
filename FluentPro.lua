            ...
            function x:SetVersion(newVersion)
                ...
                if x.Window and x.Window.TitleBar then
                    ...
                    if badge then
                        ...
                        local versions = newVersion or {}
                        if type(versions) == "string" then
                            versions = {{ Text = versions, Color = Color3.fromRGB(45, 165, 90) }}
                        elseif type(versions) == "table" and versions.Text then
                            versions = { versions }
                        end
                        badge.Visible = #versions > 0
                        for _, v in ipairs(versions) do
                            local f = Instance.new("Frame")
                            f.AutomaticSize = Enum.AutomaticSize.X
                            f.Size = UDim2.new(0, 0, 1, 0)
                            f.BackgroundColor3 = v.Color or Color3.fromRGB(45, 165, 90)
                            f.BorderSizePixel = 0
                            f.Parent = badge
                        ...
                        {Size = UDim2.new(1, -16, 1, 0), Position = UDim2.new(0, 16, 0, 0), BackgroundTransparency = 1},
                        {
                            ...
                            l(
                                "Frame",
                                {
                                    ...
                                    BackgroundTransparency = 1,
                                    LayoutOrder = 3,
                                    Visible = (n.Version ~= nil) or (p.Version ~= nil),
                                },
                                (function()
                                    local children = {
                                        l("UIListLayout", {
                                    ...
                                    local versions = n.Version or p.Version or {}
                                    if type(versions) == "string" then
                                        versions = {{ Text = versions, Color = Color3.fromRGB(45, 165, 90) }}
                                    elseif type(versions) == "table" and versions.Text then
                                        versions = { versions }
                                    ...
                                    for i, v in ipairs(versions) do
                                        ...
                                        table.insert(children, l("Frame", {
                                            AutomaticSize = Enum.AutomaticSize.X,
                                            Size = UDim2.new(0, 0, 1, 0),
                                            BackgroundColor3 = v.Color or Color3.fromRGB(45, 165, 90),
                                            BorderSizePixel = 0,
                                            LayoutOrder = i,
                                        }, {
